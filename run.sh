...
function install_dmp() {
    ...
    check_curl
    # 原GitHub下载链接
    GITHUB_URL=$(curl -s https://api.github.com/repos/Semon886/dmp/releases/latest | jq -r '.assets[] | select(.name == "dmp.tgz") | .browser_download_url')
    # 生成加速链接
...
function update_script() {
    ...
    SCRIPT_GITHUB="https://raw.githubusercontent.com/Semon886/dmp/master/run.sh"
    # 生成加速链接
